...
SC_MODULE(tb_driver){
	sc_in <bool> clk;
    sc_out<bool> rst_n;
    sc_out<sc_int<DT_LENGTH>> kernel[KER];
    sc_out<sc_int<DT_LENGTH>> image[IMG];
  //  sc_vector<sc_out<sc_int<DT_LENGTH>>> kernelv{ "kernelv",KER };
  //  sc_vector<sc_out<sc_int<DT_LENGTH>>> imagev{ "imagev", KER };
